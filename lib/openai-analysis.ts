  ...
  const content: Record<string, unknown>[] = [
    {
      ...
      text: [
        ...
        "The refined prompt must include explicit color palette, material finishes, branding/logo placement when provided, and visible hero details.",
        "If the founder names a brand or logo, include a simple visible brand mark or logo placement request.",
