  ...
  return (
    <section aria-labelledby="decision-comparison-title" className="pb-24">
      <header className="border-b border-[#17221f]/30 pb-3">
        <p className="fit-data text-[9px] font-bold uppercase tracking-[0.09em] text-[#17221f]/60">
      ...
      >
        <div className="border-b border-[#17221f]/20 px-3 py-3">
          ...
          <p className="fit-data mt-1 text-[9px] font-bold text-[#17221f]/60">
    ...
    >
      ...
      <div className="mt-2 space-y-1.5">
        {clearances.map(([axis, value]) => (
          <div key={axis}>
            <p className="fit-data text-[7px] font-bold uppercase text-[#17221f]/55">
              {axis} clearance
            </p>
            <div
...
function ComparisonProduct({
  ...
  return (
    <article className="min-w-0 border-r border-[#17221f]/20 p-2.5 last:border-r-0">
      ...
      <p className="fit-data mt-2 text-[8px] font-bold uppercase tracking-[0.07em] text-[#17221f]/55">
      ...
      <p className="fit-data mt-0.5 text-[7px] font-bold uppercase tracking-[0.06em] text-[#17221f]/55">
      ...
      <details className="group mt-3 border-t border-[#17221f]/20 pt-1">
        ...
        <div className="space-y-2 pb-2 text-[9px] leading-4 text-[#17221f]/68">
          ...
          <div>
            <p className="fit-data text-[7px] font-bold uppercase tracking-[0.07em] text-[#17221f]/50">
              Delivery packages
            </p>
  ...
  if (candidate.imageUrl === undefined) {
    return (
      <div
        ...
        className="fit-data flex aspect-[4/3] items-center justify-center border border-[#17221f]/20 bg-[#f4f7f5] p-1 text-center text-[7px] font-bold uppercase text-[#17221f]/55"
      >
        Image unavailable
      </div>
    );
